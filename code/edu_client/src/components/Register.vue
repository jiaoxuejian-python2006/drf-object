            ...
            <div class="register_box">
                ...
                <div class="inp">
                    ...
                    <div class="sms-box">
                        ...
                        <div class="sms-btn" @click="get_code" v-if="show">获取验证码</div>
                        <div class="sms-btn" @click="get_code" v-if="!show">{{time}}s后再次发送</div>

                    </div>
                    <button class="register_btn" @click="user_register">注册</button>
                    <p class="go_login">已有账号
                        <!--                        <router-link to="/login">直接登录</router-link>-->
                        <span @click="direct_login">直接登录</span>
                    </p>
                </div>
            </div>
        </div>
...
export default {
    ...
    methods:{
        ...
        get_code(){
            let reg = /1[3-9]{2}\d{8}/;
            if (this.check_phone(this.phone)){
                this.show=false
