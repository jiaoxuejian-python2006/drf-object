<template>
    <div class="login box">
        ...
        <div class="login">
            ...
            <div class="login_box">
                <div class="title">
                    <span @click="login_model_password" :class="{current:show}">密码登录</span>
                    <span @click="login_model_msg" :class="{current:!show}">短信登录</span>
                </div>
<!--                密码登录-->
...
<!--                短信登录-->
                <div class="inp" v-show="!show">
                    ...
                    <button class="login_btn" @click="user_login">登录</button>
...
export default {
    ...
    methods: {
        ...
        get_captcha() {
            ...
            this.$axios({
                url: "http://127.0.0.1:8000/user/captcha/", // 加随机数防止缓存
                method: "get",
                params: {
        ...
        user_login() {
            this.$axios({
                ...
                console.log(res);
                //登陆时 来判断用户是否需要记住密码 remember_me的值为true代表需要记住密码
                if (res.data) {
                    localStorage.token = res.data.token
                    localStorage.user = this.username
                    localStorage.id = res.data.user_id
        ...
        get_code(){
            ...
            if (reg.test(this.username)){
                ...
                this.$axios({
                    url:"http://127.0.0.1:8000/user/send/",
                    method:"get",
                    params:{
                        phone:this.phone
                    }
        ...
        check_phone(){
            this.$axios({
                url:"http://127.0.0.1:8000/user/phone/",
                method:"get",
                params:{
                    phone:this.phone
                }
