<template>
    <div class="cart">
        ...
        <div class="cart-info">
            ...
            <div class="cart-item" v-for="course in this.course_list">
                <el-row>
                    ...
                    <el-col :span="4" class="final-price">¥{{ course.final_price }}</el-col>
                </el-row>
            </div>
            <div class="calc">
                <el-row class="pay-row">
                    ...
                    <el-col :span="8">
                        ...
                        <span class="alipay wechat"><img src="../../static/image/alipay.png" alt=""></span>
                    </el-col>
    ...
    methods: {
        get_all_course() {
            this.$axios.get("http://127.0.0.1:8000/cart/order/", {
                ...
                this.total_price = res.data.total_price.toFixed(2)
            })
        },
    },
    components: {
